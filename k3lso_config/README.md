...
#### 1.2.2. Run gmapping package and move_base:
    ...
    roslaunch k3lso_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch k3lso_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch k3lso_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
